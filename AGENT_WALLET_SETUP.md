...
## How it works
- The real treasury wallet that launched $BAGENT (CA: A1omcMzYHeWg3kbyHUayq7x47ZB3Pm6cM6d8J9wcpump) is 13iZ8sLaYH8zNANdnbWXuV2i85zgspYSCVV424kzTfZT. All creator fees go here.
...
You already control the secret key (the one you used in your wallet when creating the coin on pump.fun). 
...
No demo keypair is needed anymore — this is the live treasury address.

### Using in Genesis
In your Genesis dashboard, you can spawn a "Bounty Agent" child whose purpose is:
"Use fees from the $BAGENT treasury wallet (13iZ8sLaYH8zNANdnbWXuV2i85zgspYSCVV424kzTfZT) for the live token (CA: A1omcMzYHeWg3kbyHUayq7x47ZB3Pm6cM6d8J9wcpump) to post and manage bounties on pump.fun GO for humans. Only post high-value or high-visibility tasks."
